...
public void setup() {
  ...
  scene.camera().addKeyFrameToPath(1);
  ////third camera, gets on the text
  //scene.camera().setPosition(1739.7141, 532.48267, 206.90126);
  //scene.camera().setFieldOfView(1.0471975803375244);
  //scene.camera().setUpVector(0.10743916, -0.06311959, -0.99220604);
  //scene.camera().setViewDirection(-0.94832605, -0.3061928, -0.08320916);
  //scene.camera().addKeyFrameToPath(1);
  ...
  scene.camera().addKeyFrameToPath(1);
  //fourth camera for WALL, gets on text 1;
  //scene.camera().setPosition(31.57687, 1769.6072, 47.730614);
  //scene.camera().setFieldOfView(1.0471975803375244);
  //scene.camera().setUpVector(0.02048394, 0.11446863, -0.9932157);
  //scene.camera().setViewDirection(-0.064258344, -0.9912194, -0.115563855);
  //scene.camera().addKeyFrameToPath(1);
  //fourth camera, looks at next text; 1
  //scene.camera().setPosition(-0.27198195, 1831.7245, 44.465324);
  //scene.camera().setFieldOfView(1.0471975803375244);
  //scene.camera().setUpVector(0.0027063375, 0.14539085, -0.9893706);
  //scene.camera().setViewDirection(0.09748916, -0.98469967, -0.14443776);
  //scene.camera().addKeyFrameToPath(1);
  ...
  scene.camera().addKeyFrameToPath(1);
  //fifth camera, looks at text 2
  //scene.camera().setPosition(-1962.594, 1084.615, 13.504642);
  //scene.camera().setFieldOfView(1.0471975803375244);
  //scene.camera().setUpVector(-0.093375094, -0.020997342, -0.9954095);
  //scene.camera().setViewDirection(0.9742011, -0.20824121, -0.086992905);
  //scene.camera().addKeyFrameToPath(1);
  ...
  scene.camera().addKeyFrameToPath(1);
  //sixth camera, looks at text 3
  //scene.camera().setPosition(571.4203, 1741.0881, 19.136456);
  //scene.camera().setFieldOfView(1.0471975803375244);
  //scene.camera().setUpVector(0.010056518, 0.06715858, -0.9976916);
  //scene.camera().setViewDirection(-0.11972451, -0.9904838, -0.067880206);
  //scene.camera().addKeyFrameToPath(1);
  ...
  scene.camera().addKeyFrameToPath(1);
  ////seventh camera, looks at the ending advertisement
